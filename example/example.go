...
import (
	...
	"github.com/founderio/m3u8"
	"github.com/founderio/m3u8/example/template"
)
...
func main() {
	...
	m3u8File := "github.com/founderio/m3u8/sample-playlists/media-playlist-with-custom-tags.m3u8"
